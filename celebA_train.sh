...
CUDA_VISIBLE_DEVICES=0 python3 train.py --data $DATA_DIR/celeba64_lmdb --root $CHECKPOINT_DIR --save $EXPR_ID --dataset celeba_64 \
        ...
        --batch_size 16 --num_nf 1 --ada_groups --num_process_per_node 1 --use_se --res_dist --fast_adamax --cont_training