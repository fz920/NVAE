...
CUDA_VISIBLE_DEVICES=0,1 python3 train.py --data $DATA_DIR/celeba64_lmdb --root $CHECKPOINT_DIR --save $EXPR_ID --dataset celeba_64 \
        --num_channels_enc 32 --num_channels_dec 32 --epochs 20 --num_postprocess_cells 2 --num_preprocess_cells 2 \
        ...
        --batch_size 16 --num_nf 1 --ada_groups --num_process_per_node 2 --use_se --res_dist --fast_adamax --cont_training